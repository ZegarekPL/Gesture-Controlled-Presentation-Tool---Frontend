...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <div
            className={`fixed top-0 left-0 h-full bg-background p-4 transform transition-transform duration-300 ease-in-out z-30 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:static md:translate-x-0 md:w-1/6 overflow-y-auto`}
        >
